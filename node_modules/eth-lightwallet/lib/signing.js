...
var signTx = function (keystore, pwDerivedKey, rawTx, signingAddress,hdPathString,chainType) {
  ...
  var txCopy;
  if(chainType == "swh"){
     txCopy = new SwhTransaction(new Buffer(rawTx, 'hex'));
  }else{
    txCopy = new Transaction(new Buffer(rawTx, 'hex'));
  }
